...
//    }
    ...
    NSString *dataFile = [NSString stringWithContentsOfURL:containerURL encoding:NSUTF8StringEncoding error:&err];
    ...
    for (NSString *str in dataarr)
    {
        if ([str containsString:@":"])
        {
            ...
            CXCallDirectoryPhoneNumber phoneNumber =atoll([[tempArray objectAtIndex:0] UTF8String]);
            NSString *label = [tempArray objectAtIndex:1];
